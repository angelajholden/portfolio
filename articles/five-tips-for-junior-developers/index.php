		...
		<article class="full-width_content animate__animated animate__fadeIn">
			<div class="wrap">
				...
				<div class="content-item">
					...
					<p>After more than a decade, I still practice building things I think looking interesting. All of those things have a Github repository and are deployed to a demo site with a URL. I consider everything I work on to be open source and a part of my portfolio.</p>
					<p>I'm always surprised at the situations I find myself in, and the new things I'm learning that I just haven't come across before. Try to develop the habit of becoming a life-long learner which is a skill you really need to have to work in technology where things are constantly changing. I promise you, what makes a good developer is not the person who knows the most, but rather the person who can learn quickly and is willing to take on projects and learn as they go.</p>
					...
					<p>This <a href="https://www.youtube.com/watch?v=ViNnV2W0pec" target="_blank" rel="noopener">video from Tech and Beyond with Moss</a> is a great lesson on the history of DevOps. He goes into a lot detail about why DevOps isn't just the role or responsibility of one type of engineer, but rather why it's the responsibility of all developers. He also includes a lot of historical context on how the role of DevOps in software engineering emerged.</p>
