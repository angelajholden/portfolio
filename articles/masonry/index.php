		...
		<article class="full-width_content animate__animated animate__fadeIn">
			<div class="wrap">
				...
				<div class="author-box">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem sunt ea quis minima est earum libero soluta numquam dolores! Omnis asperiores consequuntur distinctio quidem autem, nemo suscipit repudiandae nulla nostrum, itaque incidunt deserunt laudantium ut sequi? Dolor, amet repudiandae. Accusamus quo totam dolor labore quaerat quae deleniti rerum velit impedit error alias minus dicta consequuntur adipisci inventore voluptatum sequi magnam quidem sint iste, provident illo ipsum accusantium cum. Quia, accusamus! Tenetur at corrupti ipsam. A enim in, inventore numquam, excepturi, aut cupiditate nihil soluta eligendi reiciendis qui at ipsum. Quidem qui dolorum veniam nemo, sequi ex. Quasi, possimus nam?</p>
				</div>
			</div>
		</article>
	</main>
