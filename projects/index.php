...
<?php 
$title = 'Projects | Angela J Holden | Software Engineer &amp; Frontend Developer';
$description = '';
		...
		<section class="grid-projects animate__animated animate__fadeIn">
			...
			<div class="wrap">
				<article class="project-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-portfolio-website.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
				...
				<article class="project-item animate__animated animate__fast" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-ocean-blog-static-website.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-style-guide.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-frontend-mentor-product-cart-with-list.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated animate__fast" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-blog-layout-with-category-filter.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-masonry-layout.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-modal-window-project.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
				...
				<article class="project-item animate__animated animate__fast" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/projects/angelajholden-landing-page-html-css.jpg" alt="Heidi the Sheltie is looking out the window.">
					</figure>
					<div class="project-content">
