	...
	<main id="content" class="main">
		<section class="grid-projects animate__animated animate__fadeIn">
			<header class="content-header">
				...
				<p>These are frontend projects I built during live streams, with full access to the source code, working demos, and YouTube playlists. Every project is made with HTML, CSS/SCSS, and JavaScript. No frameworks, just clean, accessible code.</p>
			</header>
			<div class="wrap">
